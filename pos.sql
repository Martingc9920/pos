  ...
  (57, 'Juan Fernando Urrego', 'juan', '$2a$07$asxx54ahjppf45sd87a5auwRi.z6UsW7kVIpm0CUEuCpmsvT2sG6O', 'Mesero', 'vistas/img/usuarios/juan/461.jpg', 1, '2018-02-06 16:58:50', '2018-02-06 21:58:50'),
  (58, 'Julio Gómez', 'julio', '$2a$07$asxx54ahjppf45sd87a5auQhldmFjGsrgUipGlmQgDAcqevQZSAAC', 'Mesero', 'vistas/img/usuarios/julio/100.png', 1, '2018-02-06 17:09:22', '2018-02-06 22:09:22'),
  (59, 'Ana Gonzalez', 'ana', '$2a$07$asxx54ahjppf45sd87a5auLd2AxYsA/2BbmGKNk2kMChC3oj7V0Ca', 'Mesero', 'vistas/img/usuarios/ana/260.png', 1, '2017-12-26 19:21:40', '2017-12-27 00:21:40'),
  ...
  (62, 'Willi', 'Willi', '123', 'Mesero', 'vistas/img/usuarios/admin/191.jpg', 1, '2017-12-26 19:21:40', '2017-12-27 00:21:40');
  ...
  /*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;
          ...
          SELECT c.id as "id_cliente", c.numero, u.id as "id_mesero", u.nombre
          ...
          CREATE VIEW numero_mesas  as
          SELECT count(*)+1 as mesas FROM clientes ; 
          sELECT * FROM numero_mesas; 
  ...
  CREATE TABLE venta(
              ...
              foreign KEY (mesa) references clientes(id)
          );

    insert into venta VALUES

          (null,' 2019-05-23 01:11:04', 3, 61, 55,0),
          (null, '2019-05-24 01:11:04', 4, 60, 110,0),
          (null, '2019-05-24 01:11:04', 4, 61, 140,0),

          (null, '2019-06-21 01:11:04', 2, 61, 81,0),
          (null,' 2019-06-23 01:11:04', 3, 61, 55,0),
          (null, '2019-06-24 01:11:04', 4, 60, 110,0),
          (null, '2019-06-24 01:11:04', 4, 61, 140,0),

          (null, '2019-07-20 01:11:04', 1, 60, 337,0),
          (null, '2019-07-21 01:11:04', 2, 61, 81,0),
          (null,' 2019-07-23 01:11:04', 3, 61, 55,0),
          (null, '2019-07-24 01:11:04', 4, 60, 110,0),
          (null, '2019-07-24 01:11:04', 4, 61, 140,0);
  ...
  CREATE TABLE producto_venta(
    ...
    CREATE VIEW ventas as 
          SELECT v.id_venta as "id", v.mesa as "id_cliente", u.id as "id_vendedor", u.nombre as "nombre", v.total_pago as "total", v.fecha as "fecha"
                  FROM venta as v INNER JOIN usuarios as u
